...
# Общие настройки
$config							= array();
$config['sitelink']				= 'https://studio-phoenix.com/'; # URL сайта, со слэшем на конце
...
$config['password']				= 'KE10WmLvyPad'; # Пароль админа

# Настройки доступа в закрытую зону
$config['access_login']			= 'admin'; # Логин
$config['access_password']		= 'KE10WmLvyPad'; # Пароль

### ОТПРАВКА СООБЩЕНИЙ ###

# Настройка отправки сообщений
$config['secretWord']					= 'sdfsdfgaghah'; # Секретное слово для генерации антиспама
$config['email']['receiver']			= 'studio.phoenix@mail.ru'; # E-mail адрес, на который отправляется сообщение
